# graalvm-native, example 'spring-boot-greetingserver'
GraalVM Examples, Native Image Greetingserver running in Spring Boot Native
...
```
$ docker run --rm -p 8080:8080 spring-boot-greetingserver:0.0.1-SNAPSHOT
```
...
```
$ target/spring-boot-greetingserver
```
